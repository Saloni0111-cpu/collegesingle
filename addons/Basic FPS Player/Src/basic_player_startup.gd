...
#bool monitoring = true #For checking the arriving of player
...
func _ready():
	...
	#if Input.is_action_just_pressed("mousevisible"):
		#Input.set_mouse_mode(Input.MOUSE_MODE_VISIBLE)
		## *DeCaptured the Mouse when clicked "V" But id fk Wat m I doing...!
